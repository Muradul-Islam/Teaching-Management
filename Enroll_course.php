...
<body>
    <header class="head">
        ...
        <h3>Please Enroll your preferable course</h3>
    </header>
    <body>
        <div class="content">
            <?php	
            ...
            <div class="course_details">
                ...
                <form action="" method="post">    
                    <div class="buttons">
                        ...
                        <input type="hidden" name="course_picture" value="<?php base64_decode($final['course_picture']); ?>">
                        <button type="submit" value="submit" name="enroll_course" class="btn-submit">Enroll</button>
                    </div>
                </form>
